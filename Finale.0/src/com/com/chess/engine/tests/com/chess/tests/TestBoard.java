...
import com.com.chess.engine.classic.board.*;
import com.com.chess.engine.classic.pieces.*;
import com.com.chess.engine.classic.player.Player;
import com.com.chess.engine.classic.player.WhitePlayer;
import com.com.chess.engine.classic.player.ai.BoardEvaluator;
import com.com.chess.engine.classic.player.ai.StandardBoardEvaluator;
...
public class TestBoard {
    ...
    private void assertTrue(boolean queenSideCastleCapable) {
    }

    private void assertFalse(boolean inCheck) {
    }
    ...
    private void assertEquals(Move transitionMove, Move move) {
    }

    private void assertEquals(Board fromBoard, Board board) {
    }
    ...
    public void testBoardConsistency() {
        ...
        final MoveTransition t5 = t4.getToBoard()
                .currentPlayer()
                .makeMove(Move.MoveFactory.createMove(t4.getToBoard(), BoardUtils.INSTANCE.getCoordinateAtPosition("e4"),
                        BoardUtils.INSTANCE.getCoordinateAtPosition("d5")));
        ...
        final MoveTransition t8 = t7.getToBoard()
                .currentPlayer()
                .makeMove(Move.MoveFactory.createMove(t7.getToBoard(), BoardUtils.INSTANCE.getCoordinateAtPosition("f7"),
    ...
    private void assertEquals(String positionAtCoordinate, String a8) {
    }
