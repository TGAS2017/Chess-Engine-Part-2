...
import com.com.chess.engine.classic.player.ai.IterativeDeepening;
import com.com.chess.engine.classic.player.ai.MoveStrategy;
...
public class TestIterativeDeepening {
    ...
    private void assertEquals(Move bestMove, Move move) {
    }
